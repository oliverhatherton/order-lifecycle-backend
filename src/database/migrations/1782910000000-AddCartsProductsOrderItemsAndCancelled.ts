...
export class AddCartsProductsOrderItemsAndCancelled1782910000000 implements MigrationInterface {
  name = 'AddCartsProductsOrderItemsAndCancelled1782910000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "public"."orders_status_enum" ADD VALUE 'CANCELLED'`,
    );
